...
public class ArrayEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr); //상자 만들어진 위치(주소값) 출력
		
		//배열의 초기화 - 상자 값을 대입하는 과정
...
//		arr[5] = 60; //없는 상자에 접근하면 err
		...
		//마지막 인덱스
		System.out.println( "배열의 마지막 상자:" + arr[4] );
		...
		//배열은 값을 지정하지 않으면(초기화를 하지 않으면) 기본값으로 초기화 됩니다.
		//0, 0.0, false, null
		...
		String[] wee = {"월","화","수","목","금","토","일"};
		System.out.println( Arrays.toString(wee) );
		...
		System.out.println( "arr의 평균:" + sum/arr.length );
